...
class Recipe(Base):
    ...
    sugar_per_serving: Mapped[Decimal] = mapped_column(Numeric(10, 2))
    saturated_fat_per_serving: Mapped[Decimal] = mapped_column(Numeric(10, 2))
    fiber_per_serving: Mapped[Decimal] = mapped_column(Numeric(10, 2))
    salt_per_serving: Mapped[Decimal] = mapped_column(Numeric(10, 2))
